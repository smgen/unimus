    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand">Edit Detail Project </a>
                                        ...
                                        <div id="add-data-paket" class="card">
                                            ...
                                            <div class="card-header pb-2">
                                                <div class="d-flex align-items-center">
                                                    <h4 class="card-title">Edit Data Detail Platform</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <form action="\cms\{{ $platform->id }}\detail_platform\detail\ {{ $data->id }} }}" method="post" enctype="multipart/form-data">
                                                    @method('put')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <input name="platform_id" class="form-control" type="hidden" value="{{ $platform ? $platform->id : '' }}" readonly>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-control-label">Profile Picture</label>
                                                                <input name="profile_platform" class="form-control" type="file">
                                                                <img class="mt-3" style="max-height: 100px"
                                                                src="{{ asset('storage/' . $data->profile_platform) }}" alt="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-control-label" style="color: black">Username</label>
                                                                <input name="username_platform" class="form-control" type="text"
                                                                    value="{{ $data->username_platform }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-control-label">Url Atau Link sosmed</label>
                                                                <input name="link_platform" class="form-control" type="text"
                                                                    value="{{ $data->link_platform }}">
                                                            </div>
                                                            <div class="form-group">
