    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand">Edit Platform</a>
                                        ...
                                        <div id="add-data-paket" class="card">
                                            ...
                                            <div class="card-header pb-2">
                                                <div class="d-flex align-items-center">
                                                    <h4 class="card-title">Edit Data Platform</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <form action="\cms\platform\{{ $data->id }}" method="post" enctype="multipart/form-data">
                                                    @method('put')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-control-label">Icon Sosmed</label>
                                                                <input name="thumbnail_platform" class="form-control" type="file">
                                                                <img class="mt-3" style="max-height: 100px"
                                                                src="{{ asset('storage/' . $data->thumbnail_platform) }}" alt="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-control-label" style="color: black">Nama Sosmed</label>
                                                                <input name="name_socmed" class="form-control" type="text"
                                                                    value="{{ $data->name_socmed }}">
                                                            </div>
                                                        </div>
