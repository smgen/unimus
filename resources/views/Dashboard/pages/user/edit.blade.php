    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand">Edit User Dashboard </a>
                                        ...
                                        <div id="add-data-paket" class="card">
                                            ...
                                            <div class="card-header pb-2">
                                                <div class="d-flex align-items-center">
                                                    <h4 class="card-title">Edit User Dashboard</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <form action="\cms\user\{{ $data->id }}" method="post" enctype="multipart/form-data">
                                                    @method('put')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
