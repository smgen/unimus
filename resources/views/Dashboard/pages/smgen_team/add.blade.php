    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand"> Add SMGEN Team </a>
                                        ...
                                        <div id="add-data-paket" class="card">
                                            ...
                                            <div class="card-header pb-2">
                                                <div class="d-flex align-items-center">
                                                    <h4 class="card-title">Tambah Data SMGEN Team</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <form action="\cms\addsmgen_team" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
