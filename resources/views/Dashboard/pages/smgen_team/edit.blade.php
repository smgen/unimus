    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand">Edit SMGEN Team</a>
                                        ...
                                        <div id="add-data-paket" class="card">
                                            ...
                                            <div class="card-header pb-2">
                                                <div class="d-flex align-items-center">
                                                    <h4 class="card-title">Edit Data SMGEN Team</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <form action="\cms\smgen_team\{{ $data->id }}" method="post" enctype="multipart/form-data">
                                                    @method('put')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="thumbnail_team" class="form-control" type="file">
                                                                <img class="mt-3" style="max-height: 100px"
                                                                src="{{ asset('storage/' . $data->thumbnail_team) }}" alt="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-control-label" style="color: black">Name</label>
                                                                <input name="name_team" class="form-control" type="text"
                                                                    value="{{ $data->name_team }}">
                                                            </div>
                                                            <div class="form-group">
