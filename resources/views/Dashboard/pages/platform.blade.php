            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    <ul class="nav navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link">
                                <form method="GET" action="{{ url('/cms/platform') }}" class="form-search">
                                    <label for="search">
                    ...
                    <main class="d-flex flex-column gap-3 grow">
                        <section class="d-flex gap-2 items-center justify-content-between">
                            <div class="d-flex align-items-center ml-auto">
                                <a href="{{ url('/cms/addplatform')}}" type="button"
                                        ...
                                        <table class="table align-items-center mb-0 table-hover">
                                            <thead class="bg-grey1">
                                                <tr>
                                                    ...
                                                    <th class="text-center">Name Socmed</th>
                                                    <th>Actions</th>
                                                </tr>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img style="max-height: 100px"
                                                            src="{{ asset('storage/' . $platform->thumbnail_platform) }}" alt=""></td>
                                                    <td class="text-center">{{ $platform->name_socmed }}</td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="/cms/{{ $platform->id }}/editplatform"
                                                                class="btn btn-primary btn-sm bg-primary me-1 text-white">Edit</a>
                                                            <form action="/cms/platform/{{ $platform->id }}" method="POST"
                                                            ...
                                                            <a href="/cms/{{ $platform->id }}/detail_platform"
                                                                class="btn btn-sm btn-warning bg-warning text-black me-1">Isi Detail</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
