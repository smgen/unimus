    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand"> Add User Portal </a>
                                        ...
                                        <div id="add-data-paket" class="card">
                                            ...
                                            <script>
                                                Swal.fire({
                                                    ...
                                                    text: '{{ session('
                                                    success ') }}' + ' Nomor Keanggotaan Anda adalah: ' + '{{ $data['membership'] }}',
                                                });
                                            </script>
                                            @endif
                                            @if ($errors->any())
                                            ...
                                            <div class="card-header pb-2">
                                                <div class="d-flex align-items-center">
                                                    <h4 class="card-title">Tambah Data User Portal</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <form action="\cms\adduser_portal" method="post"
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-control-label"
                                                                    style="color: black">Nama User</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <select name="provinsi" id="provinsi" class="dynamic form-control" data-dependent="provinsi">
                                                                        ...
                                                                        @foreach($data['get_provinsi'] as $provinsi)
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input id="password" name="password"
                                                                        ...
                                                                        value="{{ old('password') }}">
                                                                    <div id="eyeicon" class="btn btn-outline-secondary">
