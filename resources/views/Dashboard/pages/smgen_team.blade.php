    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand"> SMGEN Team </a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    <ul class="nav navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link">
                                <form method="GET" action="{{ url('/cms/smgen_team') }}" class="form-search">
                                    <label for="search">
                    ...
                    <main class="d-flex flex-column gap-3 grow">
                        <section class="d-flex gap-2 items-center justify-content-between">
                            <div class="d-flex align-items-center ml-auto">
                                <a href="{{ url('/cms/addsmgen_team')}}" type="button" class="btn btn-primary rounded-lg">
                                ...
                                <div class="card-body px-0 pt-0 pb-2">
                                    <div class="table-responsive p-0">
                                        <table class="table align-items-center mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($card['get_data'] as $smgen_team)
                                                <tr>
                                                    <td class="text-center">{{ $nomor++ }}</td>
                                                    <td class="text-center"><img style="max-height: 100px"
                                                            src="{{ asset('storage/' . $smgen_team->thumbnail_team) }}" alt="">
                                                    </td>
                                                    <td class="text-center">{{ $smgen_team->name_team}}</td>
                                                    <td class="text-center">{{ $smgen_team->position->name }}</td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="/cms/{{ $smgen_team->id }}/editsmgen_team"
                                                                class="btn btn-primary btn-sm bg-primary me-1 text-white">Edit</a>
                                                            <form action="/cms/smgen_team/{{ $smgen_team->id }}" method="POST"
