    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand"> Position </a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    <ul class="nav navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link">
                                <form method="GET" action="{{ url('/cms/position') }}" class="form-search">
                                    <label for="search">
        ...
        <div class="content">
            <div class="container-fluid">
                    ...
                    <main class="d-flex flex-column gap-3 grow">
                        <section class="d-flex gap-2 items-center justify-content-between">
                            <div class="d-flex align-items-center ml-auto">
                                <a href="{{ url('/cms/addposition')}}" type="button"
                                ...
                                <div class="card-body px-0 pt-0 pb-2">
                                    <div class="table-responsive p-0">
                                        <table class="table align-items-center mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($data['get_data'] as $position)
                                                <tr>
                                                    <td class="text-center">{{ $nomor++ }}</td>
                                                    <td class="text-center">{{ $position->name }}</td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="/cms/{{ $position->id }}/editposition"
                                                                class="btn btn-primary btn-sm bg-primary me-1 text-white">Edit</a>
                                                            <form action="/cms/position/{{ $position->id }}" method="POST"
                ...
                <div class="row">
                    <p><strong>*data ini akan digunakan sebagai pilihan dalam menetapkan posisi di struktur tim SMGen dan kantor wilayah</strong></p>
                </div>
            </div>
        </div>
    </div>
