    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand"> service </a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    <ul class="nav navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link">
                                <form method="GET" action="{{ url('/cms/services') }}" class="form-search">
                                    <label for="search">
                    ...
                    <main class="d-flex flex-column gap-3 grow">
                        <section class="d-flex gap-2 items-center justify-content-between">
                            <div class="d-flex align-items-center ml-auto">
                                <a href="{{ url('/cms/addservices')}}" type="button"
                                ...
                                <div class="card-body px-0 pt-0 pb-2">
                                    <div class="table-responsive p-0">
                                        <table class="table align-items-center mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($data['get_data'] as $services)
                                                <tr>
                                                    <td class="text-center">{{ $nomor++ }}</td>
                                                    <td class="text-center"><img style="max-height: 100px"
                                                            src="{{ asset('storage/' . $services->thumbnail_services) }}"
                                                            alt=""></td>
                                                    <td class="text-center">{{ $services->title_services }}</td>
                                                    <td class="text-center">{{ $services->description_services }}</td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="/cms/{{ $services->id }}/editservices"
                                                                class="btn btn-primary btn-sm bg-primary me-1 text-white">Edit</a>
                                                            <form action="/cms/services/{{ $services->id }}"
                                                                method="POST"
