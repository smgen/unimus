    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class="container-fluid">
                <a class="navbar-brand"> Add Portofolio </a>
                                ...
                                <section class="d-flex dlex-column gap-2 mt-4">
                                    <div class="page-inner" style="width: 100%">
                                        <div id="add-data-paket" class="card">
                                            ...
                                            <div class="card-body">
                                                <form action="\cms\addportofolio" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-control-label" style="color: black">Deskripsi Portofolio</label>
