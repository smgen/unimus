...
<head>
    ...
    <title>Login Usesr-Suara Merdeka Generation</title>
            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-image">
                        <figure><img src="{{ URL::asset('/images/login_user.jpg') }}" alt="sing up image"></figure>
                        <a href="/portal/register_user" class="signup-image-link">Create an account</a>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Login</h2>
                        <form method="POST" action="/portal/login_user" class="register-form" id="login-form">
                            @csrf
