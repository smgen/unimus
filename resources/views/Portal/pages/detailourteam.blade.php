...
<body>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 order-1 order-lg-2">
                <img src="{{ asset('storage/' . $data['kantorwilayah']->thumbnail_kantorwilayah) }}" alt="Banner Image"
    ...
    <div class="wrapper" id="ourteam">
        ...
        <div class="title">
            <!-- <h6>{{ $data['kantorwilayah']->name_kantorwilayah }}</h6> -->
            <h6>Service {{ $data['kantorwilayah']->name_kantorwilayah }}</h6>
        </div>
                        ...
                        <div class="mt-5 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item d-flex flex-column text-center rounded-box">
                                <img class="image-rounded"
                                    src="{{URL::asset('storage/' . $service->thumbnail_services) }}"
