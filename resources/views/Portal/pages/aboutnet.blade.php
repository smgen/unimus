...
<body>
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="title d-flex justify-content-center"
                style="background: linear-gradient(to right, #FAA62F , #3678B2); padding:20px; border-radius:10px;">
                <h1 style="color: white;">Suara Merdeka Network</h1>
            </div>
        </div>
    </div>
    <div class="container">
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="title justify-content-start">
                <h2>Kenali SM Network lebih dalam.</h2>
            </div>
        </div>
    </div>
    <div class="container mt-5 mb-5">
            ...
            <section class="cd-horizontal-timeline">
                <div class="timeline">
                    <div class="events-wrapper" style="background: transparant;">
                        <div class="events">
                            <ol>
                                <li><a href="#0" data-date="11/02/1950" class="selected" style="color: #3678B2"> <span> 11
                                        Februari 1950 </span></a></li>
                                <li><a href="#0" data-date="03/03/1970" style="color: #3678B2">Maret 1963</a></li>
                                <li><a href="#0" data-date="11/02/1982" style="color: #3678B2">11 Februari 1982</a></li>
                                <li><a href="#0" data-date="01/01/2010" style="color: #3678B2">Sejak Tahun 2010</a></li>
                            </ol>
                ...
                <div class="events-content">
                    <ol>
                        <li class="selected" data-date="11/02/1950">
                            <h2>Terbit Pertama</h2>
                            <em>11 Februari 1950</em>
                            <p>
                                Terbit pertama 11 feb 1950, didirikan oleh H Hetami. Hetami menjabat pemimpin umum,
                        ...
                        <li data-date="01/01/2010">
                            <h2>Pergantian Kepemimpinan</h2>
                            <em>Sejak Tahun 2010</em>
                            <p>
    ...
    <img class="image-rounded" src="{{ asset('storage/' . $service->thumbnail_services) }}" style="max-height: 250px"
        alt="">
